...
export function PainelPaleta({
  ...
  return (
    <div className="max-w-[560px] space-y-5">
        ...
        <div className="space-y-2">
          {paleta.cores.map((cor, i) => (
            <div key={cor.id} className="flex items-center gap-2.5">
              ...
              <input
                ...
                className="w-full min-w-0 flex-1 rounded-md border px-2.5 py-1.5 text-[12px] outline-none focus:border-[var(--color-signal)]"
                style={inputStyle}
              />
              <span
                className="ds-data w-[70px] shrink-0 text-[11px]"
          ...
          {paleta.cores.length < 12 && (
            <button
              ...
              className="flex items-center gap-1.5 rounded-md border border-dashed px-3 py-2 text-[12px] transition-colors hover:border-[var(--color-signal)]"
      ...
      {contrasteBaixo && (
        <output
          className="block rounded-md border px-3 py-2 text-[11px] leading-relaxed"
          ...
          {TOKENS_SEMANTICOS.map((token) => {
            ...
            return (
              <div key={token} className="flex items-center gap-2">
                ...
                />
                <span
                  className="w-[140px] shrink-0 truncate text-[11px]"
                ...
                <Select
                  ...
                  opcoes={[
                    ...
                    ...paleta.cores.map((c) => ({ valor: c.id, rotulo: c.nome, descricao: c.hex })),
                  ]}
