...
import { PARECE_BOTAO, PARECE_CARD, embrulhar, porAssinatura } from './primitivas.js';
...
// As primitivas de agrupamento (`assinatura`, `porAssinatura`, `embrulhar`,
// `PARECE_BOTAO`, `PARECE_CARD`) moram em `primitivas.ts` — o passe de
// subdivisão por seção do motor V2 usa exatamente as mesmas.
